	...
	init:function(dbURL){
		...
		async.waterfall([
			...
			function(callback){
				...
				dbc.firstRun(function(err, res, message){
					...
					if(err){
						...
						if( !res ){
							...
							log.info("This is not the first time running.");
							...
							log.info("This is the first time running.");
							log.info("Setting up database.");
							
							dbc.setUpDB(function(err,message){
